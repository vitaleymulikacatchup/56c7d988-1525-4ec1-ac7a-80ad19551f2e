...
export const metadata: Metadata = {
  title: "TelReview - Honest Phone Reviews You Can Trust",
  description: "Get unbiased smartphone reviews from verified users and tech experts. Make informed phone purchase decisions with real user experiences and detailed analysis.",
  keywords: "phone reviews, smartphone reviews, mobile phone ratings, honest reviews, tech reviews, verified reviewers",
  metadataBase: new URL("https://telreview.com"),
  alternates: {
    canonical: "https://telreview.com"
  },
  openGraph: {
    title: "TelReview - Honest Phone Reviews You Can Trust",
    description: "Get unbiased smartphone reviews from verified users and tech experts. Make informed phone purchase decisions with real user experiences.",
    siteName: "TelReview",
    type: "website"
  },
  twitter: {
